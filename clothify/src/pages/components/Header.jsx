...
const Header = () => {
    ...
    return (
        ...
        <header className="flex sticky  bg-[#fbfcf0] font-mulish dark:bg-black">
            <div className="w-1/3 justify-center items-center p-5 ssm:hidden sm:hidden md:hidden ">
            ...
            <div className="w-1/3 flex justify-center items-center ssm:hidden sm:hidden md:hidden ">
                <img src={Image} className="w-40" alt="logo" />
            </div>
            <div className="flex w-1/3 justify-end items-center p-5 gap-7 ssm:hidden sm:hidden md:hidden dark:text-white">
