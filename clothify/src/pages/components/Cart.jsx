...
const Cart = () => {
    return (
        <div className={'flex flex-col  mt-[3%]   items-end '}>
            <div className='flex flex-col border-b rounded-t-xl  border-t-2 border-l-2 border-r-2 justify-end items-start  pt-2 bg-[#FFFFF5] pb-6 w-[80%]'>
            ...
            <div className=' mt[10%] flex flex-col bg-[#E5E5B6] w-[80%]  rounded-b-xl border-b-2 border-l-2 border-r-2'>
