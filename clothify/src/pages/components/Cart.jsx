    ...
    return(
        <div className='  overflow-auto ssm:overflow-x-hidden'>
            ...
            <div className='   bg-[#E5E5B6] w-[33%]  ml-[60%]  p-10 rounded-b-2xl  2xl:w-[600px]  xl:w-[600px] xl:ml-[48%] lg:ml-[45%] lg:w-[500px] md:w-[600px]  md:ml-[20%] sm:ml-[10%] sm:w-[512px] ssm:w-[260px] ssm:ml-[10%]  '>
                ...
                <button  type="button " className="   flex pl-[22%] w-[280px] mt-[10%] text-gray-900 bg-white  hover:text-white border-gray-300 focus:outline-none hover:bg-black focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-white dark:hover:text-black dark:hover:border-gray-600 dark:focus:ring-gray-700 ml-[20%]  2xl:ml-[25%] lg:ml-[6.5rem] lg:pl-[4.8rem] xl:ml-[28%] xl:pl-[12%] md:w-[60%] sm:w-[17rem] xl:w-[47] ssm:w-[150px] ssm:text-xs ssm:ml-4" >CHECK OUT</button>
                <span className='text font-mulish  font-extralight text-xs ml-[18%] text-slate-400 2xl:ml-[26.5%] lg:ml-[22%] xl:ml-[26%] sm:ml-[5.7rem]  md:ml-[25%] ssm:text-[8px] ssm:ml-2'>shipping cost and Taxes calculated on checkout</span>
            </div>
        </div>
